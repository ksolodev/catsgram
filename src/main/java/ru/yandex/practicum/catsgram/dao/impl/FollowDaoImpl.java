...
public class FollowDaoImpl implements FollowDao {
    ...
    private Follow makeFollow(ResultSet rs) throws SQLException {
        return new Follow(rs.getString("follower_id"), rs.getString("followed_id"));
    }
}
